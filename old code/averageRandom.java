...
public class averageRandom {
	...
	public synchronized static void addRandInt(){				//Synchronized function to ensure the correct incrementing of count variable so that data is
		numList.add(random.nextInt(max - min) + min);			//entered correctly
		count++;
	}
